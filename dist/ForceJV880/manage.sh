...
# and writes audio into a shared-memory ring that the separate ForceAudioJack
...
echo "  logs: /tmp/forceAudioJack.log (mix tap, in the ForceAudioJack addon), /tmp/jv_host.log (synth)"
